...
object SpyglassBuild extends Build {
  lazy val project = Project(
    ...
    Seq(
      ...
      name := "spyglass",
      version := "0.8.0-tres-SNAPSHOT",
      scalaVersion := "2.11.7",
      retrieveManaged := true,
      retrievePattern := "[artifact](-[revision])(-[classifier]).[ext]",
      libraryDependencies ++= Seq(
        "com.twitter" %% "scalding-core" % "0.16.0-RC5" % "compile",
        ...
        //"org.apache.hbase" % "hbase-client" % "1.0.0" % "test" classifier "tests",
        "org.apache.hbase" % "hbase-common" % "1.0.0" % "test" classifier "tests",
        "org.apache.hbase" % "hbase-server" % "1.0.0" % "test" classifier "tests",
        "org.apache.hbase" % "hbase-hadoop-compat" % "1.0.0" % "test",
        "org.apache.hbase" % "hbase-hadoop-compat" % "1.0.0" % "test" classifier "tests",
        "org.apache.hbase" % "hbase-hadoop2-compat" % "1.0.0" % "test",
        "org.apache.hbase" % "hbase-hadoop2-compat" % "1.0.0" % "test" classifier "tests"
      ),
